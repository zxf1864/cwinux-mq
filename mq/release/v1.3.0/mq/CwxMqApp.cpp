...
int CwxMqApp::onConnCreated(CwxAppHandler4Msg& conn, bool& , bool& )
{
    ...
    {
        conn.getConnInfo().setContinueRecvNum(m_config.getCommon().m_uiFromMasterWindowSize);
    }
    return 0;
}
///连接关闭
                        ...
                        bool& )
{
    ...
    return conn.getConnInfo().getContinueRecvNum()<conn.getConnInfo().getContinueSendNum()?1:0;
}

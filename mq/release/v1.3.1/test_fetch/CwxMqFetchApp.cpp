...
///echo回复的消息响应函数
int CwxMqFetchApp::onRecvMsg(CwxMsgBlock* msg, CwxAppHandler4Msg const& conn, CwxMsgHead const& header, bool& bSuspendConn)
{
...
//tss
CwxAppTss* CwxMqFetchApp::onTssEnv()
{
...
void CwxMqFetchApp::sendNextMsg(CWX_UINT32 uiSvrId, CWX_UINT32 uiHostId, CWX_UINT32 uiConnId){
    ...
    if (CWX_MQ_SUCCESS != CwxMqPoco::packFetchMq(pTss,
        pBlock,
        m_config.m_bBlock,

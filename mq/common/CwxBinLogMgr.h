...
class CwxBinLogHeader {
  ...
  public:
    ...
    ///构造函数
    inline CwxBinLogHeader(CWX_UINT64 ullSid, CWX_UINT32 uiLogNo,
        CWX_UINT32 uiDatetime, CWX_UINT32 uiOffset, CWX_UINT32 uiLogLen,
        CWX_UINT32 uiPrevOffset, CWX_UINT32 uiGroup);
    ///拷贝构造
...
class CwxBinLogIndex {
  ...
  public:
    ...
    ///构造函数
    inline CwxBinLogIndex(CWX_UINT64 ullSid, CWX_UINT32 uiDatetime,
        CWX_UINT32 uiOffset, CWX_UINT32 uiLogLen);
    ///拷贝构造
...
class CwxBinLogIndexWriteCache {
  ...
  public:
     ...
     */
    CwxBinLogIndexWriteCache(int indexFd, CWX_UINT32 uiIndexOffset,
        CWX_UINT64 ullSid);
    ///析构函数
...
class CwxBinLogFile {
  ...
  public:
    /**
     ...
     @return 0：成功；-1：失败。
     */
    CwxBinLogFile(CWX_UINT32 ttDay, CWX_UINT32 uiFileNo = 0,
  ...
  public:
    /**
     ...
     @return 0：成功；-1：失败。
     */
    int open(char const* szPathFile, bool bReadOnly = true,
        bool bCreate = false, char* szErr2K = NULL);
    /**
     @brief 往日志文件添加一个新日志
     ...
     */
    int append(CWX_UINT64 ullSid, CWX_UINT32 ttTimestamp, CWX_UINT32 uiGroup,
        char const* szData, CWX_UINT32 uiDataLen, char* szErr2K = NULL);
    /**
  ...
  private:
    ...
    /**
     ...
     @return -1：失败；0：成功。
     */
    inline int readIndex(int fd, CwxBinLogIndex& index, CWX_UINT32 uiOffset,
...
class CwxBinLogMgr {
  ...
  public:
    /**
     ...
     @return 无。
     */
    CwxBinLogMgr(char const* szLogPath, char const* szFilePrex,
        CWX_UINT32 uiMaxFileSize, CWX_UINT32 uiBinlogFlushNum,
        CWX_UINT32 uiBinlogFlushSecond, bool bDelOutManageLogFile = false);
    ///析构函数
    ~CwxBinLogMgr();
  public:
    /**
...
//	int trim(CWX_UINT64 ullSid, char* szErr2K=NULL);
  public:
     ...
     */
    CwxBinLogCursor* createCurser(CWX_UINT64 ullSid = 0, CWX_UINT8 ucState =
        CwxBinLogCursor::CURSOR_STATE_UNSEEK);
  ...
  private:
    ...
    ///append数据
    int _append(CWX_UINT64 ullSid, CWX_UINT32 ttTimestamp, CWX_UINT32 uiGroup,
        char const* szData, CWX_UINT32 uiDataLen, char* szErr2K = NULL);
